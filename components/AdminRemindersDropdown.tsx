    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          type="button"
        >
          <ListCheck className="h-[1.2rem] w-[1.2rem] text-muted-foreground" />
        </Button>
      </DropdownMenuTrigger>
          ...
          {reminders.length > 0 && (
            <>
              {reminders.map((reminder) => (
                <DropdownMenuItem key={reminder.id} className="flex items-center gap-2">
                  <Checkbox
          ...
          <div className="flex items-center gap-2 px-2 py-2">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button size="sm" variant="ghost" type="button" className="h-8 w-8 p-0">
