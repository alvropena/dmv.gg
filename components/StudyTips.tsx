	...
	return (
		<div>
			<div className="flex justify-between items-center mb-4">
				<h2 className="text-xl font-semibold text-white">Study Tips</h2>
			</div>
				...
				<Card>
					<CardContent className="p-4">
						<div className="flex flex-col items-center sm:flex-row sm:items-center sm:gap-3">
							...
							<div className="text-center sm:text-left">
								<h3 className="font-medium text-base">Review the handbook</h3>
								<p className="text-sm text-muted-foreground">
				...
				<Card>
					<CardContent className="p-4">
						<div className="flex flex-col items-center sm:flex-row sm:items-center sm:gap-3">
							...
							<div className="text-center sm:text-left">
								<h3 className="font-medium text-base">Use memory techniques</h3>
								<p className="text-sm text-muted-foreground">
