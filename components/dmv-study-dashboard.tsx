...
const sampleQuestions = [
  ...
  },
  {
    ...
    options: ["High beam headlights", "Low beam headlights", "Parking lights only", "Hazard lights only"],
    correctAnswer: 1,
  },
  {
    id: 5,
    ...
    imageUrl: "/placeholder.svg?height=200&width=200",
    options: ["You can pass other vehicles", "No passing zone", "Two-way traffic ahead", "Merge left"],
    correctAnswer: 1,
  },
]

export function DmvStudyDashboard() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
            ...
            {currentQuestion.options.map((option, index) => (
              <div
                ...
                className={`p-3 border rounded-lg cursor-pointer transition-colors flex items-center ${
                  ...
                  isAnswerRevealed && selectedOption === index && index !== currentQuestion.correctAnswer
      ...
      <div className="mt-6 text-center text-sm text-muted-foreground">
        <p>Keyboard shortcuts: Press 1-4 to select an option, Space to check/continue</p>
      </div>
    </div>
  )
}
