...
export default function TermsAndConditions() {
	return (
		<div className="container mx-auto px-4 py-8 max-w-4xl">
			...
			<p className="mb-4">Last updated: April 07, 2025</p>
			<p className="mb-4">
			...
			<ul className="list-disc pl-6 mb-4">
				...
				<li className="mb-2">
					<p>
						...
						this Agreement) refers to DMV.gg.
					</p>
				</li>
				<li className="mb-2">
					<p>
				...
				<li className="mb-2">
					<p>
						<strong>Website</strong> refers to DMV.gg, accessible from{" "}
						<Link
							href="https://dmv.gg"
