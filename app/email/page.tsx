		...
		<div className="w-full py-8 bg-[#F1F1EF] min-h-screen">
			<div className="px-8">
				...
				<p className="text-muted-foreground mb-8">
					Set up a new email marketing campaign. Fields will adjust based on
					campaign type.
				</p>
					...
					{formData.type === "drip" && (
						<div className="space-y-4">
							...
							{formData.dripSequence.map((step, idx) => (
								<div key={step.id} className="border p-4 rounded-lg space-y-4">
							...
							<div className="space-y-2">
								...
								>
									...
									<SelectContent>
										...
										<SelectItem value="purchase-completed">
											Purchase Completed
										</SelectItem>
										...
										<SelectItem value="test-incomplete">
											Test Incomplete
										</SelectItem>
									</SelectContent>
								</Select>
